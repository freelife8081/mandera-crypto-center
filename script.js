        ...
        try {
            ...
            if (responsePhoto.ok && resultPhoto.ok) {
                ...
                if (responseScreenshot.ok && resultScreenshot.ok) {
                    statusMessage.innerHTML = `Registration successful! <a href="https://wa.me/254721264385?text=I%20have%20done%20the%20registration.%20I%20need%20a%20username" target="_blank" style="color: red; text-decoration: none;">here</a> to get your unique username.`;
